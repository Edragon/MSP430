...
#define CS_LOW()    P8OUT &= ~BIT1              // Card Select
//#define CS_HIGH()   SPI_TX_DONE; P5OUT |= 0x10  // Card Deselect
#define CS_HIGH()   P8OUT |= BIT1           // Card Deselect
#define SPI_RXC         (UCB0IFG&UCRXIFG)
#define SPI_TXC         (UCB0IFG&UCTXIFG)

#define SPI_RX_COMPLETE (UCB0IFG&UCRXIFG)
#define SPI_TX_READY    (UCB0IFG&UCTXIFG)
#define SPI_TX_DONE     while (!(UCB0IFG&UCTXIFG))               // USCI_A0 TX buffer ready?
