...
#define Ds18b20_High  P6OUT |= BIT1    //DS18B20数据线输出高
#define Ds18b20_Low   P6OUT &= ~BIT1   //DS18B20数据线输出低
#define Ds18b20_In    P6DIR &= ~BIT1   //DS18B20数据线设置输入
#define Ds18b20_Out   P6DIR |= BIT1    //DS18B20数据线设置输出
#define Ds18b20_Value (P6IN & BIT1)    //DS18B20数据线获取值
