...
/********************2.8寸液晶管脚定义 Start***********************************/
#define LCD_Data_Port           PEOUT                    //P9、P10组成PE口为数据口

#define LCD_RS_CLR	        P8OUT &= ~BIT7           //RS置低
#define LCD_RS_SET	        P8OUT |=  BIT7           //RS置高

#define LCD_RW_CLR	        P8OUT &= ~BIT4           //RW置低
#define LCD_RW_SET	        P8OUT |=  BIT4           //RW置高

#define LCD_RD_CLR	        P8OUT &= ~BIT5           //E置低
#define LCD_RD_SET	        P8OUT |=  BIT5           //E置高

#define LCD_CS_CLR	        P8OUT &= ~BIT6            //CS置低
#define LCD_CS_SET	        P8OUT |=  BIT6            //CS置高

#define LCD_RST_CLR	        P8OUT &= ~BIT3            //RST置低
#define LCD_RST_SET	        P8OUT |=  BIT3            //RST置高

#define LCD_BL_CLR	        P8OUT &= ~BIT0            //LE置低
#define LCD_BL_SET	        P8OUT |=  BIT0            //LE置高
/*********************2.8寸液晶管脚定义 END************************************/
#define LCD_W 240
#define LCD_H 320
